...
writecsv("$(homedir())/Documents/brinkman-stokes/julia/efficient-operators/temp/sol/x.csv", x)
writecsv("$(homedir())/Documents/brinkman-stokes/julia/efficient-operators/temp/sol/y.csv", y)
writecsv("$(homedir())/Documents/brinkman-stokes/julia/efficient-operators/temp/sol/ux.csv", ux)
writecsv("$(homedir())/Documents/brinkman-stokes/julia/efficient-operators/temp/sol/uy.csv", uy)
