...
function flowplot(sol, kparams, domain)
	...
	streamlines_file = get_output_file("matrix-free-stacked", domain, msize, "streamlines.png"; subdir = "plots")
	figure(figsize = (10, 8))
	...
	velocity_file = get_output_file("matrix-free-stacked", domain, msize, "velocity_field.png"; subdir = "plots")
	figure(figsize = (10, 8))
