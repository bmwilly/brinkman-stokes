...
function solve_stokes(domain, msize)
	...
	restrt = min(500, length(rhs))
	tol = 1.0e-6  # gmres parameters
	@time (
	...
	convergence_file = get_output_file("matrix-free-tensor", domain, msize, "convergence.png"; subdir = "plots")
	figure(figsize = (10, 6))
	...
	outfile = get_output_file("matrix-free-tensor", domain, msize, "convergence_data.csv")
