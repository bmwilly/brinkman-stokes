reload("diffusion/shape.jl")
reload("diffusion/qshape.jl")
reload("diffusion/cshape.jl")

###CDERIV evaluates derivatives of bicubic shape function
#input
...
function cderiv(s, t, xl, yl)
    ...
    (chie, dchids, dchidt) = cshaspe(s, t)
